...
class CustomPopupWindow(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        reset_icon_path = get_resource_path(
            os.path.join("icons", "restore" + ("_dark" if colorMode == "dark" else "_light") + ".png")
        )
    ...
    def toggle_edit_mode(self):
        ...
        icon_path = os.path.join(
            os.path.dirname(sys.argv[0]), "icons", f"{icon_name}_{'dark' if colorMode == 'dark' else 'light'}.png"
        )
        if os.path.exists(icon_path):
