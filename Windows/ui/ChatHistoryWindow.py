...
class ChatListItem(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        delete_btn.setIcon(QtGui.QIcon(get_resource_path(os.path.join('icons', 'cross' + ('_dark' if colorMode == 'dark' else '_light') + '.png'))))
...
class ChatHistoryWindow(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        refresh_btn.setIcon(QtGui.QIcon(get_resource_path(os.path.join('icons', 'regenerate' + ('_dark' if colorMode == 'dark' else '_light') + '.png'))))
